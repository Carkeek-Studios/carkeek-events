...
if ( ! class_exists( 'CarkeekEvents' ) ) {
	...
	final class CarkeekEvents {
		...
		public function includes() {
			...
			require_once CARKEEKEVENTS_PLUGIN_DIR . 'includes/class-carkeekevents-calendar.php';
			...
			require_once CARKEEKEVENTS_PLUGIN_DIR . 'includes/class-carkeekevents-editor.php';
